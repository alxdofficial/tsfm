...
DATASET_CONFIGS = {
    ...
    "realdisp": {
        "synonyms": {
            ...
            "rowing": ["rowing", "rowing motion"],
            "elliptical_bike": ["elliptical bike", "elliptical machine"],
            "jump_up": ["jumping up", "vertical jump"],
            "jump_front_back": ["jumping front and back"],
            "jump_sideways": ["jumping sideways", "lateral jump"],
            "jump_legs_arms": ["jumping with legs and arms"],
            "jump_rope": ["jump rope", "skipping rope"],
            "trunk_twist_arms_out": ["trunk twist arms outstretched"],
            "trunk_twist_elbows_bent": ["trunk twist elbows bent"],
            "waist_bends_forward": ["waist bending forward"],
            "waist_rotation": ["waist rotation", "torso twist"],
            "waist_bend_cross": ["waist bend crossing"],
            "reach_heels_backwards": ["reaching heels backwards"],
            "lateral_bend": ["lateral bending", "side bend"],
            "lateral_bend_arm_up": ["lateral bend with arm up"],
            "forward_stretching": ["forward stretching"],
            "upper_lower_twist": ["upper and lower body twist"],
            "lateral_arm_elevation": ["lateral arm elevation"],
            "frontal_arm_elevation": ["frontal arm elevation"],
            "frontal_hand_claps": ["frontal hand claps"],
            "frontal_crossing_arms": ["frontal crossing of arms"],
            "shoulders_high_rotation": ["shoulders high rotation"],
            "shoulders_low_rotation": ["shoulders low rotation"],
            "arms_inner_rotation": ["arms inner rotation"],
            "knees_to_breast": ["knees to breast"],
            "heels_to_backside": ["heels to backside"],
            "knees_bending_crouching": ["knees bending crouching"],
            "knees_alternating_forward": ["knees alternating forward"],
            "rotation_on_knees": ["rotation on knees"],
        },
        "templates": ["{}"],
    },
    "daphnet_fog": {
        "synonyms": {
            "walking": ["walking", "normal gait"],
            "freezing_gait": ["freezing of gait", "gait freeze", "movement freeze"],
        },
        "templates": ["{}"],
    },
}
