...
| **C4** | HIGH | ACTIVE | Headline ZS open-set **42.0%** | **42.0% = mean over the 5 MAIN datasets only** (MobiAct 42.2 / MotionSense 49.3 / RealWorld 48.0 / Shoaib 49.2 / Opportunity 21.1). All-7 mean (with VTT 1.3, HARTH 2.0) ≈ **30.4%**. | `tsfm_evaluation_small_deep_v2.json` |
