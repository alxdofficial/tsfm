"""
Tests for RecGym dataset conversion.

Run: python datascripts/recgym/test_convert.py
"""
...
def test_manifest_structure():
    ...
    assert manifest["dataset_name"] == "RecGym", "Wrong dataset name"
...
def run_all_tests():
    """Run all tests."""
    print("=" * 80)
    print("RecGym Dataset Conversion Tests")
    print("=" * 80)

    if not OUTPUT_DIR.exists():
        print(f"\n✗ Output directory not found: {OUTPUT_DIR}")
        print("Run conversion first: python datascripts/recgym/convert.py")
        return False
