...
Includes:
- Label groups for synonym handling
...
def get_group_members(label: str, label_to_group: Dict[str, str], use_simple: bool = False) -> List[str]:
    """
    ...
    Args:
        ...
        label_to_group: Mapping from labels to group names
        use_simple: If True, use LABEL_GROUPS_SIMPLE instead of LABEL_GROUPS
    """
