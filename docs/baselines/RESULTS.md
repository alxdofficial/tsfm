...
2. **TSFM leads at 10% supervised, MOMENT leads at 1%** — At 10%, TSFM leads with 83.2% vs
   MOMENT 81.3% avg accuracy. At 1%, MOMENT leads (71.5% vs 68.2%), likely benefiting from its
   larger embedding dimension (6144 vs 384) and general time-series pretraining.
